...
<?php
 ...
 if (isset($_SERVER['HTTP_REFERER'])) {
     ...
     echo $referer;
     // ตรวจสอบว่าแหล่งที่มา (referer) ตรงกับ URL หน้าแรก
     if ($urls === $referer) {
         // เปลี่ยนเส้นทางไปยัง URL ที่ต้องการ
...
<head>
    ...
    <title>Shop โทรศัพท์ PG v9 </title>
    <!-- Favicon-->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="#!"><img src="logo.png" width="70px" alt=""></a>
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                ...
                <p class="lead fw-normal text-white-50 mb-0">สมาร์ทโฟนจอใหญ่ ราคาถูก เบอร์โทร 022970360
                </p>
            </div>
        </div>
    </header>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
                                ...
                                <!-- Product price-->
                                <span class="text-muted text-decoration-line-through">1,999 บาท</span> 1,099 บาท
                            </div>
                        </div>
                        <!-- Product actions-->
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
                                ...
                                <h5 class="fw-bolder">โทรศัพท์ PG v9</h5>
                                <!-- Product price-->
                                <span class="text-muted text-decoration-line-through">$50.00</span> 1,099 บาท
                            </div>
                        </div>
                        <!-- Product actions-->
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
                                ...
                                <!-- Product price-->
                                <span class="text-muted text-decoration-line-through">$20.00</span> 1,099 บาท
                            </div>
                        </div>
                        <!-- Product actions-->
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">โทรศัพท์ PG v9 &copy; โทรศัพท์ PG v9 2023 เบอร์โทร 022970360
            </p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
